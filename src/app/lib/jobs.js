...
export const arr = [
  {
    ...
    uniqueId: uuidv4(),
    bullets: [
      'Obtained substantial cost savings by developing/implementing highly effective real estate structure for a major client.',
      ...
      'Increased productivity and collaboration by leading integration of new team members, while facilitating rapid assimilation into existing team.',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Held role of Regional Lead for BEPS Pillar II analysis, modelling and implementation.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Provided comprehensive analysis of UK Diverted Profits Tax legislation and its application to Schroders.',
      'Secured tax savings and incentives for innovation by spearheading first claims for R&D tax credits on behalf of UK group companies.',
      ...
      'Realised accuracy and compliance with tax regulations by providing technical updates on share options tax/tax accounting calculations.',
    ],
  },
  {
    ...
    description:
      'Offered tax compliance and advisory services to a portfolio of UK banks and insurance companies. Took a secondment to the accounting advisory team.',
    uniqueId: uuidv4(),
    bullets: [
      'Took a secondment to the Accounting Advisory team and assited with advisory projects for UK banks.',
      'Assisted with tax aspects of inbound banks into the UK.',
    ],
  },
  {
    title: 'Tax Assistant',
    ...
    where: 'KPMG, London, UK',
    description:
      'Offered tax compliance and advisory services to a portfolio of UK banks and insurance companies. Completed training to become a Chartered Accountant and Chartered Tax Adviser.',
    uniqueId: uuidv4(),
    bullets: [
      'Completed Chartered Accountant qualification.',
      'Completed Chartered Tax Adviser qualification.',
      'Seconded to the Tax Technology team where I assisted in managing the tools used by the Tax functions.',
    ],
  },
];
